  ...
  head: () => ({
    meta: [
      { title: "The Zynovax Growth Engine™ — A System for Compounding Revenue" },
      {
        name: "description",
        content:
          "The proprietary five-stage operating system Zynovax uses to engineer compounding revenue: Visual Identity, Social Presence, Performance Ads, CRO Funnels and Global Scale.",
      },
      { property: "og:title", content: "The Zynovax Growth Engine™" },
      {
        property: "og:description",
        content: "A five-stage operating system for compounding revenue.",
      },
    ],
  }),
      ...
      <div className="animate-slide-down-page">
              ...
              <div className="lg:col-span-7">
                ...
                <h1 className="mt-7 text-4xl sm:text-5xl lg:text-[80px] font-semibold leading-[0.98] tracking-[-0.04em] text-ink text-balance">
                  ...
                  <span className="font-display italic font-normal text-gradient-brand">
                    Five compounding stages.
                  </span>
                </h1>
                <p className="mt-7 max-w-2xl text-lg text-ink-soft leading-[1.55]">
                  Not a bundle of disconnected services. A proprietary operating system for growth.
                  Every stage feeds the next, and every stage is measured against revenue metrics.
                </p>
                <div className="mt-9">
                  <LiquidMetalButton
        ...
        <section className="bg-white pb-24 lg:pb-32">
          <Container>
                ...
                {stages.map((s, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`mt-1 text-lg font-semibold ${on ? "text-ink" : "text-ink-soft group-hover:text-ink"}`}
                      >
                        {s.t}
                      </div>
            ...
            <div
              key={a.t}
              className="mt-14 rounded-[28px] bg-ink text-white p-10 lg:p-16 shadow-elegant animate-rise overflow-hidden relative"
            >
