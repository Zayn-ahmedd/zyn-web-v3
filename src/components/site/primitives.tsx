...
export function PrimaryButton({
  ...
  const inner = (
    <>
      <ArrowRight 
        className="absolute w-4 h-4 left-[-25%] stroke-white fill-none z-10 group-hover:left-4 group-hover:stroke-black transition-all duration-[800ms] ease-[cubic-bezier(0.34,1.56,0.64,1)]" 
      />
      ...
      <ArrowRight 
        className="absolute w-4 h-4 right-4 stroke-white fill-none z-10 group-hover:right-[-25%] group-hover:stroke-black transition-all duration-[800ms] ease-[cubic-bezier(0.34,1.56,0.64,1)]" 
      />
    </>
  );
...
export function GhostButton({
  ...
  const inner = (
    <>
      <ArrowUpRight 
        className="absolute w-4 h-4 left-[-25%] stroke-[#111111] fill-none z-10 group-hover:left-4 group-hover:stroke-white transition-all duration-[800ms] ease-[cubic-bezier(0.34,1.56,0.64,1)]" 
      />
      <span className="relative z-10 transition-all duration-[800ms] ease-out group-hover:translate-x-4">
        {children}
      </span>
      ...
      <ArrowUpRight 
        className="absolute w-4 h-4 right-4 stroke-[#111111] fill-none z-10 group-hover:right-[-25%] group-hover:stroke-white transition-all duration-[800ms] ease-[cubic-bezier(0.34,1.56,0.64,1)]" 
      />
    </>
  );
