  ...
  return (
    ...
    >
      ...
      <g transform="skewX(-15) translate(20, 0)">
        ...
        {/* O */}
        <path fillRule="evenodd" clipRule="evenodd" d="M 116 10 H 140 C 143 10 145 12 145 15 V 45 C 145 48 143 50 140 50 H 116 C 113 50 111 48 111 45 V 15 C 111 12 113 10 116 10 Z M 119 18 V 42 H 137 V 18 Z" />
